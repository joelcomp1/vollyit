...
Invite People to Volly It with Your Organization!</h3>
<div class="clear"></div>
...
<a href="https://www.facebook.com/sharer/sharer.php?u=http://volly.it&t=Help Change the World!" target="_blank" ><img src="../images/facebook.png" width="62" height="22" alt="Facebook"  /></a>


<a href="https://twitter.com/intent/tweet?text=Help us change the world! We are on Volly.it and you should be to!  Hop onto Volly.it today and start Volunteering! <?php echo $_SESSION['ORG_INVITE_LINK']; ?>"  target="_blank" >
...
<input id="Field1" name="Field1" type="text" class="field text large" value="<?php echo $_SESSION['ORG_INVITE_LINK']; ?>" size="50" tabindex="5"  />
...
<form id="Sendemail" name="Sendemail" method="post" action="send-org-email.php">
...
style="resize: none;"
spellcheck="true" 
rows="8" cols="37" >Hi! We are now on Volly.it and are looking for volunteers to help out with our programs!  Hop onto Volly.it today and start volunteering with us!
</textarea>
</div>
