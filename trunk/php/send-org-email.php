<?php
	...
	$message .= $_SESSION['ORG_NAME']; 
	$message .= " wanted to let you know:</p><p>";
	$message .= $content;
	$message .= "</p>";
	$message .= "<a href='";
	$message .= $_SESSION['ORG_INVITE_LINK'];
	...
	{
		smtpmailer($emailAddressArray, $emailAddressArrayOfNames, $_SESSION['ORG_EMAIL'], $_SESSION['ORG_NAME'], 'Volly.It - Help change the world! ', $message);
	}
   ...
   session_write_close();
   header("location: invite-volunteers.php");
