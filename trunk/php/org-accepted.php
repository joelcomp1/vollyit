...
?>
				...
				<div id="programImageTable" style="float:none; padding: 0px 0px 0px 0px;"><img src="uploaded_files/<?php echo $orgInfo['orgimage']; ?>" alt="User Picture" width="40" height="40"></div>
