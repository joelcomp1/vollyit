...
$mail->IsHTML(true);		 										
$mail->From = 'service@angelleye.com';				
$mail->FromName = 'Angell EYE';
...
$Option = array(
				...
				'l_shippingoptionamount' => '1.00', 						// Shipping option amount.  Required if specifying the Callback URL.  
...
$Option = array(
				...
				'l_shippingoptionname' => 'UPS', 							// Shipping option name.  Required if specifying the Callback URL.  50 character max.
				'l_shipingpoptionlabel' => 'UPS', 							// Shipping option label.  Required if specifying the Callback URL.  50 character max.
				'l_shippingoptionamount' => '18.00', 						// Shipping option amount.  Required if specifying the Callback URL.  
				'l_taxamt' => '0.00', 										// New tax amount based on this shipping option and address.
				'l_insuranceamount' => '1.00' 								// New insurance amount based on this shipping option and address.
				);
...
$mail->Subject  =  'PayPal Express Checkout Shipping Callback Hit Successfully!';
$mail->Body = $request_content . '<br /><br />' . $response_content_body . '<br /><br />' . $callback_data_response;
