...
$SCBAFields = array(
					'returnurl' => 'http://joelcomp1.no-ip.org/php/member-reg-org.php?paid=true', 									// Required.  URL to which the customer's browser is returned after chooing to pay with PayPal.
					'cancelurl' => 'http://joelcomp1.no-ip.org/php/member-reg-org.php?paid=false', 									// Required.  URL to which the customer is returned if he does not approve the use of PayPal to pay you.
